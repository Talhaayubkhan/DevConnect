...
const Header = () => {
  ...
  return !userData ? (
    <div className="navbar bg-gradient-to-r from-blue-800 to-indigo-900 fixed top-0 z-50 shadow-lg  h-16">
      ...
      <div className="flex items-center">
        <div className="mx-4 rounded-lg shadow-md">
          <button
            className="btn btn-outline rounded-xl text-lg font-simbold"
